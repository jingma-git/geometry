...
*/
		...
		public:
			...
			void setNormal(const MVector3 &new_vec) { normal_ = new_vec; }
			...
			void setColor(const MRGBf &c)
			{
				color_[0] = c.r;
				color_[1] = c.g;
				color_[2] = c.b;
			}
			void setColor(const MRGBAf &c)
			{
				color_[0] = c.r;
				color_[1] = c.g;
				color_[2] = c.b;
			...
			{
				texcoord_[0] = u, texcoord_[1] = v;
				texcoord_[2] = w;
			}
			void setTexture(Texcoord &t)
			{
				texcoord_[0] = t[0];
				texcoord_[1] = t[1];
				texcoord_[2] = t[2];
...
*/
		...
		public:
			...
			void setHalfedge(MHalfedge *he) { he_ = he; }
			void setVert(MVert *v1, MVert *v2)
			{
				v1_ = v1;
				v2_ = v2;
			}
...
*/
		...
		public:
			...
			void setColor(MRGBf &c)
			{
				color_[0] = c.r;
				color_[1] = c.g;
				color_[2] = c.b;
			}
			void setColor(MRGBAf &c)
			{
				color_[0] = c.r;
				color_[1] = c.g;
				color_[2] = c.b;
