...
namespace egl
{
    ...
    template <class T, bool managed, class Alloc = std::allocator<T>>
    class In_place_list;
    ...
    public:
        ...
        typedef In_place_list_iterator<T, Alloc> iterator;
        typedef In_place_list_const_iterator<T, Alloc> const_iterator;
    ...
    void In_place_list<T, managed, Alloc>::
        insert(In_place_list_iterator<T, Alloc> position, size_type n)
    {
        while (n--)
    ...
    template <class T, bool managed, class Alloc>
    void In_place_list<T, managed, Alloc>::
        insert(In_place_list_iterator<T, Alloc> position, size_type n, const T &x)
    {
        while (n--)
    ...
    template <class T, bool managed, class Alloc>
    void In_place_list<T, managed, Alloc>::
        erase(In_place_list_iterator<T, Alloc> first,
              In_place_list_iterator<T, Alloc> last)
    {
        while (first != last)
            erase(first++);
    }
